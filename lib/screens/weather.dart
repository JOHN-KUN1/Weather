  ...
  Future<void> getWeatherData(String userCity) async {
    ...
    if (response.statusCode >= 400) {
      ...
      setState(() {
        ...
        userLocation = userCity[0].toUpperCase() + userCity.substring(1);
        ...
        // data for next day
        var nextDayDate = DateTime(
          int.tryParse(forecastDays[1]['date'].toString().split('-')[0])!,
          int.tryParse(forecastDays[1]['date'].toString().split('-')[1])!,
          int.tryParse(forecastDays[1]['date'].toString().split('-')[2])!,
        );
        ...
        // data for next day 2
        var nextDay2Date = DateTime(
          int.tryParse(forecastDays[2]['date'].toString().split('-')[0])!,
          int.tryParse(forecastDays[2]['date'].toString().split('-')[1])!,
          int.tryParse(forecastDays[2]['date'].toString().split('-')[2])!,
        );
                        ...
                        child: SearchBar(
                          ...
                          leading: IconButton(
                            onPressed: () async {
                              ...
                              await getWeatherData(_textController.text);
                            },
